...
def main():
    ...
    parser.add_argument(
        '--testNum', type=int, default=8, help='number of testing data')   
    ...
    logpath=path+"/log/temp_ssp_"+dataname
    #print(data_path)
    #print(pair_path)
    #print(stoGraphPath)
    #print(featurePath)
    ...
    #one_slack_svm.w = np.random.rand(one_slack_svm.model.size_joint_feature)
