...
from SSP import SSP_InputInstance
...
'--dataname',  default='col', 
                choices=['kro', 'ny', 'col'])
parser.add_argument(
    '--vNum', type=int, default=512, choices=[1024,768,512, 4039],
...
args.logpath=path+"/results/temp_ssp_dspn"


instance = SSP_InputInstance(stoGraphPath, None, 0, vNum, 
                             None,  featureRandom = True,
                             thread = args.thread)
...
dataset_all = DSPN_utils.TestDataset(pair_path, trainNum+testNum+valNum, args.batch_size, allLineNums, vNum,train=True)
max_set_size=dataset_all.max_size
#max_set_size=vNum
dataset_train = DSPN_utils.TestDataset(pair_path, trainNum, args.batch_size, trainLineNums, vNum, train=True, max_size=max_set_size)
dataset_test = DSPN_utils.TestDataset(pair_path,  testNum, args.batch_size, testLineNums, vNum, train=False, max_size=max_set_size)
#print(dataset_test.data)
dataset_val = DSPN_utils.TestDataset(pair_path,  valNum, args.batch_size, valLineNums, vNum, train=False, max_size=max_set_size)
